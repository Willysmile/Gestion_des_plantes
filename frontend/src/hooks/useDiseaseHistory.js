  ...
  const addDisease = async (diseaseData) => {
    ...
    try {
      ...
      const cleanData = {
        ...
        disease_name: diseaseData.disease_name && diseaseData.disease_name.trim() ? diseaseData.disease_name : null,
        treatment: diseaseData.treatment && diseaseData.treatment.trim() ? diseaseData.treatment : null,
